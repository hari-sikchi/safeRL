        ...
        for t in range(self.config.num_rollout_steps):
            ...
            if 1:
                ...
                if t%self.config.logtostdout_freq==0:
                    print("\rMain policy | Reward@step #{}: {}, Cumulative Reward: {}".format(episode_step, r, episode_reward))
                ...
                if t%self.config.logtostdout_freq==0:
                    ...
                    print("\rRecovery policy | Reward@step #{}: {}, Cum Reward: {}".format(episode_step, r,episode_reward))
