...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_path', type=str, default='trained_policies/Madras-explore5')
    parser.add_argument('--logdir', type=str, default='trained_policies/Madras-explore5')
